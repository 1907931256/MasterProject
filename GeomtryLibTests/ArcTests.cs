...
namespace GeometryLibTests
{
    ...
    public class ArcTests
    {
        ...
        public void Arc_Translate_returnVal()
        {
            ...
            Arc arcTrans = arc.Translate(new Vector3(1, 1, 2));
            ...
            Assert.AreEqual(arc.SweepAngleDeg, arcTrans.SweepAngleDeg,"sweep");
        }
        [TestMethod]
        public void Arc_RotateX_returnVal()
        {
            ...
            Arc arcRot = arc.RotateX(new Vector3(), Math.PI);
        ...
        public void Arc_RotateY_returnVal()
        {
            ...
            Arc arcRot = arc.RotateY(new Vector3(), Math.PI);
        ...
        public void Arc_RotateZ_returnVal()
        {
            ...
            Arc arcRot = arc.RotateZ(new Vector3(), Math.PI);
