...
namespace FileIOLibTests
{
    ...
    {
        void createException(string testmessage)
        {
            try
            {
        ...
        public void LogFile_SaveMessage_MessageIsException_SavesExceptionMessage()
        {
            ...
            List<string> fileContents = FileIO.ReadDataTextFile(errorlogfilename);
        ...
        public void LogFile_Ctor_logsAreEqual()
        {
            ...
            List<string> fileContents = FileIO.ReadDataTextFile(fileName);
